...
const CollectionOfferModal = ({ open, onOpenChange, collection }: CollectionOfferModalProps) => {
  ...
  const FormContent = () => (
    <div className="space-y-6">
      <div>
        ...
        <h4 className="text-primary mb-4 font-serif text-xl md:text-2xl uppercase tracking-wide">
          {collection.name}
        </h4>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogOverlay />
      <DialogContent className="max-w-5xl w-full p-0 gap-0 grid grid-cols-[1fr,1.2fr]">
        {/* Left: Image */}
